...
/// generated by a user or bot user. If the message is generated
/// by a webhook, the author object corresponds to the webhook's
/// id, username, and avatar. You can tell if a message is generated
/// by a webhook by checking for the webhook_id on the message object.
...
pub const PartialMember = struct {};
